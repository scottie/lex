Contributing to LEXcore
============================

The LEXcore project operates an open contributor model where anyone is
...
The following applies to code changes to the LEXcore project, and is not to be
confused with overall LEX Network Protocol consensus changes.

Whether a pull request is merged into LEXcore rests with the project merge
...
Patches that change LEX consensus rules are considerably more involved than
...
Where a patch set proposes to change the LEX consensus, it must have been
...
The project leader is the release manager for each LEXcore release.
