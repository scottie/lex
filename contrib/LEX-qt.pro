...
RESOURCES += src/qt/LEX.qrc src/qt/LEX_locale.qrc

TRANSLATIONS += src/qt/locale/LEX_bg.ts \
                src/qt/locale/LEX_de.ts \
                src/qt/locale/LEX_en.ts \
                src/qt/locale/LEX_es.ts \
                src/qt/locale/LEX_fi.ts \
                src/qt/locale/LEX_fr.ts \
                src/qt/locale/LEX_it.ts \
                src/qt/locale/LEX_ja.ts \
                src/qt/locale/LEX_pl.ts \
                src/qt/locale/LEX_pt.ts \
                src/qt/locale/LEX_ru.ts \
                src/qt/locale/LEX_sk.ts \
                src/qt/locale/LEX_sv.ts \
                src/qt/locale/LEX_vi.ts \
                src/qt/locale/LEX_zh_CN.ts \
                src/qt/locale/LEX_zh_TW.ts
