...
This means one can have an always-on LEXd instance running, and another local LEXd/LEX-qt instance which connects to this node and receives blocks from it.
