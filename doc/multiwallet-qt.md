...
In order to support loading of multiple wallets in LEX-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is LEX.cpp.
...
Changes to LEX.cpp
----------------------
LEX.cpp is the entry point into LEX-qt, and as such, will require some minor modifications to provide hooks for
