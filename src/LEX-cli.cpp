...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("LEXcore RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  LEX-cli [options] <command> [params]  " + _("Send command to LEXcore") + "\n" +
                        "  LEX-cli [options] help                " + _("List commands") + "\n" +
                        "  LEX-cli [options] help <command>      " + _("Get help for a command") + "\n";
