...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LEXcore LEX-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  LEX-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded LEX transaction") + "\n" +
                               "  LEX-tx [options] -create [commands]   " + _("Create hex-encoded LEX transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded LEX transaction
