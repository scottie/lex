...
#include "genesis/LEXMainNetwork.cpp"
#include "genesis/LEXTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::LEXMainNetwork: return c_genesisInfoLEXMainNetwork;
	case Network::LEXTestNetwork: return c_genesisInfoLEXTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::LEXMainNetwork: return c_genesisStateRootLEXMainNetwork;
	case Network::LEXTestNetwork: return c_genesisStateRootLEXTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
