...
////////////////////////////////////////////////////////////// // LEX
	void setLEXSchedule(EVMSchedule _LEXSchedule) const { LEXSchedule = _LEXSchedule; }

	EVMSchedule& getLEXSchedule() const { return LEXSchedule; }
...
private:
	...
	mutable EVMSchedule LEXSchedule; // LEX
