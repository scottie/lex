...
#include <LEX/LEXDGP.h>
#include <libethereum/ChainParams.h>
#include <libethashseal/Ethash.h>
#include <libethashseal/GenesisInfo.h>
#include <script/standard.h>
#include <LEX/storageresults.h>
///////////////////////////////////////////

extern std::unique_ptr<LEXState> globalState;
...
using ExtractLEXTX = std::pair<std::vector<LEXTransaction>, std::vector<EthTransactionParams>>;
///////////////////////////////////////////
...
void EnforceContractVoutLimit(ByteCodeExecResult& bcer, ByteCodeExecResult& bcerOut, const dev::h256& oldHashLEXRoot,
                              const dev::h256& oldHashStateRoot, const std::vector<LEXTransaction>& transactions);
...
class LEXTxConverter{

public:

    LEXTxConverter(CTransaction tx, CCoinsViewCache* v = NULL, const std::vector<CTransaction>* blockTxs = NULL) : txBit(tx), view(v), blockTransactions(blockTxs){}

    bool extractionLEXTransactions(ExtractLEXTX& LEXTx);
...
private:
    ...
    LEXTransaction createEthTX(const EthTransactionParams& etp, const uint32_t nOut);
...
public:
    ...
    ByteCodeExec(const CBlock& _block, std::vector<LEXTransaction> _txs, const uint64_t _blockGasLimit) : txs(_txs), block(_block), blockGasLimit(_blockGasLimit) {}
