                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    resize(1080, 735);
    QString windowTitle = tr("LEXcore") + " - ";
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LEX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and LEX: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LEXcore"), this);
    aboutAction->setStatusTip(tr("Show information about LEXcore"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LEX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LEX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LEX addresses"));
    ...
    openAction->setStatusTip(tr("Open a LEX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LEXcore help message to get a list with possible LEX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LEXcore client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("LEXcore"); // default title
