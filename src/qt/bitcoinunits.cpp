...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(LEX);
    unitlist.append(mLEX);
    unitlist.append(uLEX);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case LEX:
            return QString("tLEX");
        case mLEX:
            return QString("mtLEX");
        case uLEX:
            return QString::fromUtf8("μtLEX");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case LEX:
            return QString("LEX");
        case mLEX:
            return QString("Milli-LEX (1 / 1" THIN_SP_UTF8 "000)");
        case uLEX:
            return QString("Micro-LEX (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case LEX:
            return QString("TestLEXs");
        case mLEX:
            return QString("Milli-TestLEX (1 / 1" THIN_SP_UTF8 "000)");
        case uLEX:
            return QString("Micro-TestLEX (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
