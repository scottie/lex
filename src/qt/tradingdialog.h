...
#ifndef LEX_TRADINGDIALOG_H
#define LEX_TRADINGDIALOG_H
...
private slots:
    ...
    void showBalanceOfLEXOnTradingTab();
    ...
    void showBalanceOfLEXOnSendTab();
    void showBalanceOfLEXOnBalanceTab();
    ...
    QString BuyLEX(QString OrderType, double Quantity, double Rate);
    QString SellLEX(QString OrderType, double Quantity, double Rate);
    ...
    QString sendRequest(QString url, QString method = "GET", QString body = QString("{\"market\":\"LEX/BTC\"}"));// "{\"gender\":\"male\"}");
    void sendRequest1(QString url, std::function<void (void)> funcForCallAfterReceiveResponse, QString method = "GET", QString body = QString("{\"market\":\"LEX/BTC\"}"));// "{\"gender\":\"male\"}");
