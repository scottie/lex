...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LEX features */
        {"LEX", "masternode", &masternode, true, true, false},
        //{"LEX", "masternodelist", &masternodelist, true, true, false},
        //{"LEX", "mnbudget", &mnbudget, true, true, false},
        //{"LEX", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        //{"LEX", "mnfinalbudget", &mnfinalbudget, true, true, false},
        //{"LEX", "mnsync", &mnsync, true, true, false},
        {"LEX", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        //{"LEX", "darksend", &darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use LEXd, or the -server option to LEX-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> LEX-cli " + methodname + " " + args + "\n";
}
