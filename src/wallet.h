...
enum AvailableCoinsType {
    ...
    ONLY_NONDENOMINATED_NOTMN = 4, // ONLY_NONDENOMINATED_NOT10000IFMN = 4, ONLY_NONDENOMINATED and not 10000 LEX at the same time
};
...
public:
    ...
    std::map<std::string, CLEXNodeConfig> mapMyLEXNodes;
    bool AddLEXNodeConfig(CLEXNodeConfig nodeConfig);
