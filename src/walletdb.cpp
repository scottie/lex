...
bool CWalletDB::WriteLEXNodeConfig(std::string sAlias, const CLEXNodeConfig& nodeConfig)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadLEXNodeConfig(std::string sAlias, CLEXNodeConfig& nodeConfig)
{
    return Read(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig);
}

bool CWalletDB::EraseLEXNodeConfig(std::string sAlias)
{
    nWalletDBUpdated++;
