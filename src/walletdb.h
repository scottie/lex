...
public:
    ...
    bool WriteLEXNodeConfig(std::string sAlias, const CLEXNodeConfig& nodeConfig);
    bool ReadLEXNodeConfig(std::string sAlias, CLEXNodeConfig& nodeConfig);
    bool EraseLEXNodeConfig(std::string sAlias);
